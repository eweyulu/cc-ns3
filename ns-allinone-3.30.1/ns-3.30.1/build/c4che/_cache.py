...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.5-3.5.3=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.5-3.5.3=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.5-3.5.3=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.5-3.5.3=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SIGNAL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_INTTYPES_H': '', 'INT64X64_USE_128': '', 'HAVE_LIBXML2': '', 'HAVE_RT': '', 'HAVE_PACKET_H': '', 'HAVE___UINT128_T': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_STDINT_H': '', 'HAVE_GETENV': '', 'HAVE_PYEMBED': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_DIRENT_H': '', 'HAVE_SQLITE3': '', 'PYTHONARCHDIR': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYTHON_H': '', 'HAVE_UINT128_T': '', 'HAVE_GSL': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PYEXT': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'PYTHONDIR': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['udp', 'energy', 'realtime', 'tcp', 'naming', 'wireless', 'stats', 'matrix-topology', 'ipv6', 'traffic-control', 'tutorial', 'routing', 'udp-client-server', 'socket', 'error-model']
...
INCLUDES_PYEMBED = ['/usr/include/python3.5m']
INCLUDES_PYEXT = ['/usr/include/python3.5m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/usr/lib/python3.5/config-3.5m-x86_64-linux-gnu', '/usr/lib']
LIBPATH_PYEXT = ['/usr/lib/python3.5/config-3.5m-x86_64-linux-gnu', '/usr/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = ['boost_system', 'boost_signals', 'boost_filesystem']
LIB_GSL = ['gsl', 'gslcblas', 'm']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.5m', 'pthread', 'dl', 'util', 'm', 'python3.5m', 'pthread', 'dl', 'util', 'm']
LIB_PYEXT = ['python3.5m', 'pthread', 'dl', 'util', 'm', 'python3.5m', 'pthread', 'dl', 'util', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/ns-3.30.1/build/src/fd-net-device', '/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/ns-3.30.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/ns-3.30.1/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3.30.1'
WITH_PYBINDGEN = '/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/pybindgen-0.20.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/ns-3.30.1/build/ns3/config-store-config.h', '/local/home/ndilo/Dropbox/Emily_Dell/cc-ns3/ns-allinone-3.30.1/ns-3.30.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
pyext_PATTERN = '%s.cpython-35m-x86_64-linux-gnu.so'
