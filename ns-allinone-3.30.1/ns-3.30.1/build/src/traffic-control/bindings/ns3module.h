...
public:
    ...
    static PyObject * _wrap_DoInitialize(PyNs3CobaltQueueDisc *self);
    inline void DoInitialize__parent_caller()
    { ns3::QueueDisc::DoInitialize(); }

    static PyObject * _wrap_DoDispose(PyNs3CobaltQueueDisc *self);
    inline void DoDispose__parent_caller()
    { ns3::CobaltQueueDisc::DoDispose(); }

    static PyObject * _wrap_NotifyConstructionCompleted(PyNs3CobaltQueueDisc *self);
    inline void NotifyConstructionCompleted__parent_caller()
    { ns3::ObjectBase::NotifyConstructionCompleted(); }

    static PyObject * _wrap_NotifyNewAggregate(PyNs3CobaltQueueDisc *self);
    inline void NotifyNewAggregate__parent_caller()
    { ns3::Object::NotifyNewAggregate(); }
